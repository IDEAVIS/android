...
import io.ideavis.presenter.interfaces.BRAuthCompletion;
...
public class WithdrawBchActivity extends BRActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String iso = BRSharedPrefs.getPreferredBTC(this) ? "IVC" : BRSharedPrefs.getIso(this);
        BigDecimal amount = iso.equalsIgnoreCase("IVC") ?
...
//                    }
    ...
    public static void setBCHTxId(String txId) {
        ...
        if (app != null) {
            ...
            Context activity = IdeaVis.getBreadContext();
