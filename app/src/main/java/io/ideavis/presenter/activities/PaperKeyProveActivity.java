...
import io.ideavis.tools.security.SmartValidator;
...
//        wordEditSecond.setOnFocusChangeListener(new FocusListener());
        ...
        if (wordArray.length == 12 && cleanPhrase.charAt(cleanPhrase.length() - 1) == '\0') {
            ...
            BRReportsManager.reportBug(new IllegalArgumentException("Paper Key error, please contact support at contact@ideavis.io"), false);
        } else {
